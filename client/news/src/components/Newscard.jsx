...
function Newscard({ author, content, title, urlimg, srcname, publishedat, desc }) {
  return (
    <div className='flex flex-col justify-center items-center border-2  m-4 p-4 rounded bg-white' style={{ flexBasis: 'calc(33.33% - 2rem)' }}>
      ...
      <div className='mt-4'><button className='p-3 bg-blue-300 text-white'>Read Article</button></div>
    </div>
  );
}
